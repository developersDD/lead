                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary" id="hidepanel1">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" name="addAnnouncementForm"
                                ng-submit="addAnnouncement(addAnnouncementForm.$valid, addAnnouncementForm)" novalidate
                                autocomplete="off">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                                <textarea ng-model="newAnnouncement.content" class="form-control" name="content" placeholder="Announcement Content" required></textarea>
                                            <span class="text-danger" ng-show="addAnnouncementForm.content.$error.required && !addAnnouncementForm.content.$pristine">This field is required.</span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <select class="form-control" name="status_id" ng-model="newAnnouncement.status_id"
                                                required>
                                                <option value="1">Active</option>
                                                <option value="2">Inactive</option>
                                            </select>
                                            <span class="text-danger" ng-show="addAnnouncementForm.status_id.$error.required && !addAnnouncementForm.status_id.$pristine">This field is required.</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9 text-right">
                                            ...
                                            <md-button type="submit" 
                                                ...
                                                ng-disabled="addAnnouncementForm.$invalid">Submit</md-button>
                                        </div>
                                    </div>
                                </fieldset>
                            </form>
...
<!-- ++++++++++++++++++ Angular Controllers +++++++++++++++ -->
<script> var announcements = {};</script>
