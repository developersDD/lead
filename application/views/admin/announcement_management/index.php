<?php $this->load->view('admin/_includes/sidemenu'); ?>
	...
	<aside class="right-side" ng-controller="announcementBoardManagementCTRL">
        ...
        <section class="content data-table-custom">
            <div class="row" ng-init="getAnnouncements()">
                <div class="col-lg-12">
                    <div class="panel panel-success filterable panel-scroll1">
                        	...
                        	<div class="row">
                        		<div class="col-md-6">
                        			<h3 class="panel-title displY-in">
                                 		<i class="icon icon-Message-List" data-name="message-new" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Announcement List
                            		</h3>
                        		</div>
                        		<div class="col-md-6 text-right	">
                                    <md-button class="md-btn-sm md-raised md-corner add-user-btn" ng-click="loadAddAnnouncement();"> Add Announcement</md-button>
                        		</div>
                        	</div>
                        </div>
                        <div class="panel-body">
                            <table class="table table-striped table-bordered"  datatable="ng" dt-options="dtOptions">
                                ...
                                <tbody>
                                    <tr ng-repeat="row in announcements">
                                        <td><span ng-bind="$index+1"></span></td>
                                        <td><span ng-bind="(row.content | limitTo:msgLimit)"></span>
                                            <span ng-if="row.content.length > msgLimit">...</span></td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="button-dropdown" data-buttons="dropdown">
                                                ...
                                                <ul class="button-dropdown-menu-below" style="display: none;">
                                                    <li>
                                                        <a class="" href="<?= base_url('admin/announcement/details/'); ?>{{row.id}}">
                                                            View Details
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="" href="<?= base_url('admin/announcement/edit/'); ?>{{row.id}}">
                                                            Edit Details
                                                        </a>
                                                    </li>
