<?php $this->load->view('admin/_includes/sidemenu'); ?>
	...
	<aside class="right-side" ng-controller="branchManagementCTRL">
        ...
        <section class="content data-table-custom">
            <div class="row" ng-init="getBranches()">
                <div class="col-lg-12">
                    <div class="panel panel-success filterable panel-scroll1">
                        	...
                        	<div class="row">
                        		<div class="col-md-6">
                        			<h3 class="panel-title displY-in">
                                 		<i class="icon-User-List" data-name="branchs" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> User List
                            		</h3>
                        		</div>
                        		<div class="col-md-6 text-right	">
                                    <md-button class="md-btn-sm md-raised md-corner add-user-btn" ng-click="loadAddBranch();">
                                     Add Branch </md-button>
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered"  datatable="ng" dt-options="dtOptions">
                                ...
                                <tbody>
                                    <tr ng-repeat="row in branches">
                                        <td><span ng-bind="$index+1"></span></td>
                                        <td><span ng-bind="row.branch_name"></span></td>
                                        <td><span ng-bind="row.branch_code"></span></td>
                                        <td><span ng-bind="row.branch_email"></span></td>
                                        <td><span ng-bind="row.branch_mobile"></span></td>
                                        <td><span ng-bind="row.branch_fax"></span></td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="button-dropdown" data-buttons="dropdown">
                                                ...
                                                <ul class="button-dropdown-menu-below" style="display: none;">
                                                    <li>
                                                        <a class="" href="<?= base_url('admin/branches/details/'); ?>{{row.id}}">
                                                            View Details
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a class="" href="<?= base_url('admin/branches/edit/'); ?>{{row.id}}">
                                                            Edit Details
                                                        </a>
                                                    </li>
                                                    <li class="button-dropdown-divider">
                                                        <!-- <?= base_url('admin/branches/delete/'); ?>{{row.id}}-->
