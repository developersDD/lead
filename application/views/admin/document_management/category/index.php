<?php $this->load->view('admin/_includes/sidemenu'); ?>
	...
	<aside class="right-side" ng-controller="documentCategoryManagementCTRL">
        ...
        <section class="content data-table-custom">
            <div class="row" ng-init="getDocumentCategory()">
                <div class="col-lg-12">
                        	...
                        	<div class="row">
                        		<div class="col-md-6">
                        			<h3 class="panel-title displY-in">
                                 		<i class="icon icon-Document-Category-List" data-name="list" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Document Category List
                            		</h3>
                        		</div>
                        		<div class="col-md-6 text-right	">
                                    <md-button class="md-btn-sm md-raised md-corner add-user-btn" ng-click="loadAddDocumentCategory();"> Add Document Category</md-button>
                        		</div>
                        	</div>
                        </div>
                                        ...
                                        <td>
                                            <div class="button-dropdown" data-buttons="dropdown">
                                                ...
                                                <ul class="button-dropdown-menu-below" style="display: none;">
                                                    <li>
                                                        <a class="" href="<?= base_url('admin/document/category/edit/'); ?>{{row.id}}">
                                                            Edit Details
                                                        </a>
                                                    </li>
