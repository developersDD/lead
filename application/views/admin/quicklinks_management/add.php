                    ...
                    <div class="panel panel-primary" id="hidepanel1">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="icon icon-Add-New-Quicklink" data-name="link" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                                Add New Quick Link
                            </h3>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" name="addQuickLinkForm" 
                                ng-submit="addQuickLink(addQuickLinkForm.$valid, addQuickLinkForm)" novalidate 
                                autocomplete="off">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input name="link_name" type="text" ng-model="newQuickLink.link_name"
                                                placeholder="Link Name" class="form-control"
                                                required>
                                            <span class="text-danger" ng-show="addQuickLinkForm.link_name.$error.required && !addQuickLinkForm.link_name.$pristine">This field is required.</span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input name="link_address" type="text" ng-model="newQuickLink.link_address"
                                                placeholder="Link Address" class="form-control"
                                                ng-pattern="urlPattern" required>
                                            <span class="text-danger" ng-show="addQuickLinkForm.link_address.$error.required && !addQuickLinkForm.link_address.$pristine">This field is required.</span>
                                            <span class="text-danger" ng-show="addQuickLinkForm.link_address.$error.pattern && !addQuickLinkForm.link_address.$pristine">Invaid input.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="status_id">Status <span class="text-danger">*</span></label>
                                        <div class="col-md-6">
                                            <select class="form-control" name="status_id" ng-model="newQuickLink.status_id"
                                                required>
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9 text-right">
                                            ...
                                            <md-button type="submit" 
                                                ...
                                                ng-disabled="addQuickLinkForm.$invalid">Submit</md-button>
                                        </div>
                                    </div>
                                </fieldset>
                            </form>
