<?php $this->load->view('admin/_includes/sidemenu'); ?>
	...
	<aside class="right-side" ng-controller="bannerManagementCTRL">
        ...
        <section class="content data-table-custom">
            <div class="row" ng-init="getBanners()">
                <div class="col-lg-12">
                    <div class="panel panel-success filterable panel-scroll1">
                        	...
                        	<div class="row">
                        		<div class="col-md-6">
                        			<h3 class="panel-title displY-in">
                                 		<i class="icon icon-Banner" data-name="list" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i> Banner List
                            		</h3>
                        		</div>
                        		<div class="col-md-6 text-right	">
                                    <md-button class="md-btn-sm md-raised md-corner add-user-btn" ng-click="loadAddBanner();"> Add Banner </md-button>
                        		</div>
                        	</div>
                        </div>
                        <div class="panel-body">
                            <table class="table table-striped table-bordered"  datatable="ng" dt-options="dtOptions">
                                ...
                                <tbody>
                                    <tr ng-repeat="row in banners">
                                        <td><span ng-bind="$index+1"></span></td>
                                        <td><span ng-bind="row.banner_name"></span></td>
                                        <td>
                                            <img ng-src="<?= base_url('site_data/banners/'); ?>{{row.banner_image}}" alt="Banner" width="300px" height="150px"/>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="button-dropdown" data-buttons="dropdown">
                                                ...
                                                <ul class="button-dropdown-menu-below" style="display: none;">
                                                    <li>
                                                        <a class="" href="<?= base_url('admin/settings/banner/edit/'); ?>{{row.id}}">
                                                            Edit Details
                                                        </a>
                                                    </li>
