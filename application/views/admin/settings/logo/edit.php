                    ...
                    <div class="panel panel-primary" id="hidepanel1">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="icon icon-Logo" data-name="clock" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                                Edit Logo
                            </h3>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" name="editLogoForm"  
                                ng-submit="updateLogo(editLogoForm.$valid, editLogoForm)" novalidate autocomplete="off">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input name="logo_name" type="text" ng-model="editlogo.logo_name"
                                                placeholder="Logo Name" class="form-control"
                                                required>
                                            <span class="text-danger" ng-show="editLogoForm.logo_name.$error.required && !editLogoForm.logo_name.$pristine">This field is required.</span>
                                        </div>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <div>
                                                    <span class="btn btn-default btn-file">
                                                        ...
                                                        <input type="file" name="img" ng-model="editlogo.logo_image" upload-files multiple>
                                                    </span>
                                        ...
                                        <div ng-if="editlogo.logo_image">
                                        <label class="col-md-1" for="date">Last Upload</label>
                                        <div class="col-md-4">
                                            <img class="last-upload" src="<?= base_url('site_data/logos/'); ?>{{editlogo.logo_image}}" alt="Logo">
                                        </div>
                                        </div>
                                    </div>                                
                                    ...
                                    <!--<div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select class="form-control" name="status_id" ng-model="editlogo.status_id"
                                                required>
                                                <option value="1">Active</option>
                                                <option value="2">Inactive</option>
                                            </select>
                                            <span class="text-danger" ng-show="editLogoForm.status_id.$error.required && !editLogoForm.status_id.$pristine">This field is required.</span>
                                        </div>
                                    </div>-->
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-9 text-right">
                                            ...
                                            <md-button type="submit" 
                                                ...
                                                ng-disabled="editLogoForm.$invalid">Update</md-button>
                                        </div>
                                    </div>
                                </fieldset>
                            </form>
...
<!-- ++++++++++++++++++ Angular Controllers +++++++++++++++ -->
<script>
    var editlogo = JSON.parse('<?= $logo_details; ?>');
</script>
